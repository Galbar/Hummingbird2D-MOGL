#ifndef MOGL_SHADER_PROGRAM_INCLUDE_HPP
#define MOGL_SHADER_PROGRAM_INCLUDE_HPP
...
public:
    ...
    /*!
      \brief Add a shader to the Shader to the ShaderProgram
...
/*!
  ...
  if (!prog.isLinked())
  {
    hum::log_e("Shader program failed to link:");
    hum::log_e(prog.log());
    return 1;
  }
